...
public class MostFrequentlyUsed extends PageReplacement {
        ...
        for (int i = 0; i < referenceString.length; ++i) {
            ...
            if (frame != -1) {
                ...
                if (freeFrame != -1) {
                    ...
                    int toReplace = 0;
                    // the current largest usage frequency
                    int currentMax = 0;
                    for (int j = 0; j < numberOfFrames; ++j) {
                        if (frequency[j] > currentMax) {
                            toReplace = j;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        MostFrequentlyUsed mostFrequentlyUsed = new MostFrequentlyUsed();
        mostFrequentlyUsed.demo();
    }
}
